...
if ($raw === false || $raw === '') respond(400, ['ok' => false, 'error' => 'Empty body']);
...
if (!in_array($category, ['agent', 'ptcf', 'design'], true)) respond(400, ['ok' => false, 'error' => 'category must be agent|ptcf|design']);
